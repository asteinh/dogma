classdef HTMLWriter < dogma.writer.Writer
  ...
  methods (Access = public)
    function obj = HTMLWriter(outputdir, dogma_)
      ...
      fprintf(fileID, '%s\n', 'The content of this folder is auto-generated by [dogma](', dogma_URL, ').');
      fclose(fileID);
    end
  end
  ...
  methods(Access = private)
    ...
    function txt = html_footer(obj)
      txt = { ...
              '  </div>', ...
              '</div>', ...
              '<div id="footer">&copy;' num2str(year(now)) '&ndash; generated by <a href="' obj.dogma_URL '">dogma</a></div>', ...
              '</body>', ...
              '</html>' ...
            };
    end
